...
public class Quadrant
{
    public static void main( String[] args) {
        ...
        System.out.println("Enter your x co-ordinate");  //prompt the user for an x-coordinate
        x = keys.nextDouble();
        System.out.println("Enter your y co-ordinate");  //prompt the user for a y-coordinate
        y = keys.nextDouble();
        keys.close();
